        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Control general de las novedades</div>
                    ...
                    <div class="panel-body">
                        <table id="news" class="display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                            @foreach(json_decode($new_datas) as $new_data)
                                <tr>
                                    <td>{{ $new_data->date }}</td>
                                    <td>{{  App\User::getNameById($new_data->user_id) }}</td>
                                    <td>{{ $new_data->news_day }}</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
