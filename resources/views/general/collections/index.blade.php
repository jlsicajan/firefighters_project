        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Control general de las recaudaciones</div>
                    ...
                    <div class="panel-body">
                        <table id="station_datas" class="display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                            @foreach(json_decode($collection_datas) as $collection_data)
                                <tr>
                                    <td>{{ $collection_data->date }}</td>
                                    <td>{{  App\User::getNameById($collection_data->user_id) }}</td>
                                    <td>{{ $collection_data->quantity }}</td>
                                    <td>{{ $collection_data->description }}</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
