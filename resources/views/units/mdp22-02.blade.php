        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">UNIDAD MDP-22-02</div>

                    <div class="panel-body">
                        <div class="text-center">
                            <img class="img-responsive" src="/images/unitys/MDP-22-02.jpg" style="margin: 0 auto; height: 250px; width: 350px">
                        </div>
                        <hr>
                        ...
                        <div class="tab-content">
                            <div id="enfermedadcomun" class="tab-pane fade in active">
                                ...
                                @include('units.layouts.basic_form', ['unity_set' => 'MDP22-02', 'general_case' => 'Enfermedad comun'])
                            </div>
                            <div id="accidente" class="tab-pane fade">
                                <h3>Ingrese los datos para accidente</h3>
                                @include('units.layouts.basic_form_accident', ['unity_set' => 'MDP22-02', 'general_case' => 'Accidente'])
                            </div>
                            <div id="social" class="tab-pane fade">
                                <h3>Ingrese los datos para servicio social</h3>
                                @include('units.layouts.basic_form_social', ['unity_set' => 'MDP22-02', 'general_case' => 'Servicio social'])
                            </div>
                        </div>
                    </div>
                </div>
