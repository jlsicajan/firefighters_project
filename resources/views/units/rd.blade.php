        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">UNIDAD RD-19</div>

                    <div class="panel-body">
                        <div class="text-center">
                            <img class="img-responsive" src="/images/unitys/rd19.jpeg" style="margin: 0 auto; height: 250px; width: 350px">
                        </div>
                        <hr>
                        ...
                        <div class="tab-content">
                            <div id="enfermedadcomun" class="tab-pane fade in active">
                                ...
                                @include('units.layouts.basic_form', ['unity_set' => 'RD19', 'general_case' => 'Enfermedad comun'])
                            </div>
